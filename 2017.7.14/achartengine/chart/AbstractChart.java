...
public abstract class AbstractChart implements Serializable {
  ...
  private static float[] calculateDrawPoints(float p1x, float p1y, float p2x, float p2y,
    ...
    float drawP2x;
    float drawP2y;
   // Log.e("输入值","  x1= "+Float.valueOf(p1x).toString()+" y1= "+Float.valueOf(p1y).toString()+" x2 ="+Float.valueOf(p2x).toString()+" y2 ="+Float.valueOf(p2y).toString());
    ...
    //Log.e("输出值","  x1= "+Float.valueOf(drawP1x).toString()+" y1= "+Float.valueOf(drawP1y).toString()+" x2 ="+Float.valueOf(drawP2x).toString()+" y2 ="+Float.valueOf(drawP2y).toString());
  ...
  protected void drawPath(Canvas canvas, List<Float> points, Paint paint, boolean circular) {
   ...
   // Log.e("chartpoint长度",Integer.valueOf(length).toString());
    ...
    for (int i = 4; i < length; i += 2) {
      ...
      path.lineTo(tempDrawPoints[2], tempDrawPoints[3]);
     // Log.e("tempDrawPoint i="+Integer.valueOf(i).toString(),"0 = "+Float.valueOf(tempDrawPoints[0]).toString()+"  1 = "+Float.valueOf(tempDrawPoints[1]).toString()+" 2 ="+Float.valueOf(tempDrawPoints[2]).toString()+" 3 = "+Float.valueOf(tempDrawPoints[3]).toString());
    }
    if (circular) {
      path.lineTo(points.get(0), points.get(1));
    }
    canvas.drawPath(path, paint);
    //Log.e("Abstract","drawPath"+" kk== "+Integer.valueOf(kk).toString());
  }
